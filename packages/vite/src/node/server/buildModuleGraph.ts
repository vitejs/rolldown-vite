...
export class BuildModuleNode {
  ...
  get lastInvalidationTimestamp(): number {
    throw new Error(
      'BuildModuleNode get lastInvalidationTimestamp is not support',
    )
  }
...
export class BuildModuleGraph {
  ...
  updateModuleTransformResult(
    ...
    throw new Error(
      'BuildModuleGraph updateModuleTransformResult is not support',
    )
  }
  ...
  getBackwardCompatibleBrowserModuleNode(
    ...
    throw new Error(
      'BuildModuleGraph getBackwardCompatibleBrowserModuleNode is not support',
    )
  }
  ...
  getBackwardCompatibleServerModuleNode(
    ...
    throw new Error(
      'BuildModuleGraph getBackwardCompatibleServerModuleNode is not support',
    )
  }

  getBackwardCompatibleModuleNode(
    _mod: EnvironmentModuleNode,
  ): BuildModuleNode {
    throw new Error(
      'BuildModuleGraph getBackwardCompatibleModuleNode is not support',
    )
  }
  ...
  getBackwardCompatibleModuleNodeDual(
    ...
    throw new Error(
      'BuildModuleGraph getBackwardCompatibleModuleNodeDual is not support',
    )
  }
}
  ...
  return {
    ...
    renderStart() {
      ...
      for (const id of this.getModuleIds()) {
        ...
        moduleNode!.importers = new Set(
          moduleInfo.importers.map(
            (importerId) => moduleGraph.idToModuleMap.get(importerId)!,
          ),
        )
      }
    },
